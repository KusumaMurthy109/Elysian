          ...
          >
            {posts.map((post) => {
              ...
              return (
                <View
                  key={post.id}
                  style={profileStyles.scrollGrid}
                >
                    ...
                    >
                      <View style={profileStyles.likeOverlay}>
                          <View style={profileStyles.likeTag}>
                              <Text style={profileStyles.likeCountText}>{post.likeCount ?? 0}</Text>
                              <Ionicons 
                ...
                >
                    ...
                    <View style={styles.modalWrapper}>
                        ...
                        <View style={homeStyles.contentContainer}>
                            ...
                            <Text style={homeStyles.reviewFont}>
                            {openPost.review}
                            </Text>
                            ...
                            <View style={[homeStyles.postIcons, { flexDirection: 'row', alignItems: 'center' }]}>
                              <Text style={profileStyles.openPostLikeCountText}>{openPost.likeCount ?? 0}</Text>
                              <Ionicons 
